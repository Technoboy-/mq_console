...
public class TpsAction extends AbstractAction {
     ...
     * @return
     */
    @RequestMapping(value = "/consumerGroupTps.do", method = {RequestMethod.GET, RequestMethod.POST})
    public String consumerGroupTps(ModelMap map) {
        putPublicAttribute(map, "consumerGroupTps");
        return TEMPLATE;
    }
